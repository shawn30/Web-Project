...
<body>
    <div id="container">
       ...
       <div id="header">
           <div id="navigation">   
                <div id="nav1">
                <a href="loggedin.php" class="nav1">HOME</a> 
                <a href="myevent.php" style="cursor:pointer;" class="nav1">MY EVENTS</a>
                </div>
                <div id="nav2">
                <a href="logout.php" class="nav2" style="cursor: pointer;">Logout</a>
                <a  class="nav2" style="cursor: pointer">Welcome <?php echo $_COOKIE["user"]; ?></a>
                </div>
           </div>
           <div id="search">
           <div id="logo">
   ...
   <div id="signuppage" class="modal-content animate">
     ...
     -->  
       ...
       <div id="body">
           ...
           <div id="create" onclick="location.href='creator.php'"><a >CREATE EVENT</a></div>
           </div>   
